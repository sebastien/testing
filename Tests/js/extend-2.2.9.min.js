...
var extend=extend||{}
var self=extend
extend.__VERSION__='2.2.9';extend.Counters={'Instances':0}
...
{var args=[];var i=0;while((args.length<arguments.length))
...
{result.push(e)}},self)
return result}
extend.foldl=function(seed,iterable,callback){var self=extend;var first=true;var result=seed;extend.iterate(iterable,function(e){result=callback(result,e);},self)
return result}
